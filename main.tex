...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item For one of the 3 unique targets, create a forging in both stainless steel \& aluminum, showing the controllers are robust to model uncertainty / material properties. 
	\end{itemize}
